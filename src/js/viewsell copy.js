// API Configuration
        ...
        const SHEET_RANGE = "Sell!A2:D"; // Date, Product ID, Product Name, Quantity (4 columns)
         ...
         * This is necessary for sorting, as standard Date parsing is unreliable for this format.
        ...
        /**
         * Renders the sales data based on the current filters (date and product search).
         */
        ...
        /**
         * Generates and inserts the HTML structure for the filtered sales data.
         */
        ...
        window.addEventListener('load', function() {
            // 1. Initialize the layout (assuming this function is defined in nav-layout.js)
