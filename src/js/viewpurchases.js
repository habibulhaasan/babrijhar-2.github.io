// API Configuration (No Change)
        ...
        function sortPurchaseData(data) {
            ...
            return data.sort((a, b) => {
                // Safely parse dates for accurate comparison. Note: Using the modified utility function 
                // which normalizes time to 00:00:00. This is okay for general sorting by day.
        ...
        function renderDataHTML(data) {
            const dataContainer = document.getElementById('data-container');
            const totalQuantityValueSpan = document.getElementById('total-quantity-value'); // NEW
