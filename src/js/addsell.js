...
function initializeFirstRow() {
    ...
    const quantityInput = firstRow.querySelector('input[name="sell_quantity[]"]');
    const priceInput = firstRow.querySelector('input[name="sell_price[]"]');
    ...
    document.getElementById('SellForm').addEventListener('submit', function(event) {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                console.error('Failed to add Sell.');
            }
        })
        .catch(error => {
            document.body.removeChild(spinner); // Remove spinner
